...
public class GorgonRoamState : IState<DesktopPet>
{
    ...
    {
        pet.PlayAnimation("GorgonRun", loop: true);
    ...
    public void ApplyDirection(DesktopPet pet, bool movingRight, double speed = 40.0)
    {
        _speed = speed;
